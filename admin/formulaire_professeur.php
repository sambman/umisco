            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title">Ajouter un  nouveau  Professeur</h4>
                </div>
                <div class="modal-body">
          <form action="gestion_professeur.php" method="POST" id="form2">
          <div class="row">
            <div class="col-md-6">
            ...
            <input type="text" class="form-control" name="grade" tabindex="7" required><br/>
            ...
            <div class="col-sm-6 col-xs-6 col-md-6 col-md-6">
               ...
               <input type="text" class="form-control" name="specialite" tabindex="8"  required><br/>
