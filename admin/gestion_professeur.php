...
?>
  ...
  if(isset($_REQUEST["enregistrer"]))
  {
    ...
    if(empty($id))
    {
     ...
     addProfesseur($login,$password,$nom,$prenom,$email,$num_tel,$grade,$specialite);
      ?>
      <script>
        alert('Professeur ajouté avec succes');
       document.location.href="gestion_professeur.php";
      </script>
