...
<?php
  ...
  include_once("menu_chercheur.php");
?>



  <?php
  include_once("formulaire_chercheur.php");
  include_once("fonction.php");
  $result=listingUser_by_type_user(2);  
            ...
            <table class="table  table-bordered table-striped table-condensed" id="mytable">
                ...
                <tbody>
                  <?php
                    ...
                    {
                      echo "<tr>";
                      echo'<form method="Post" action="delete_chercheur.php">';
                  ?>  
...
}else
{
   ?>
          ...
          <b>Hello!</b> Aucun chercheur dans la base de données !
...
<?php
  if(isset($_REQUEST["delete"]))
  {
   ...
   echo' document.location.href="delete_chercheur.php"';
   echo "</script>";
