            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title">Ajouter un  nouveau  Etudiant</h4>
                </div>
                <div class="modal-body">
          <form action="gestion_etudiant.php" method="POST" id="form2">
          <div class="row">
            <div class="col-md-6">
            ...
            <label for="text"> N° carte Etudiant</label>
            <input type="text" class="form-control" name="numetudiant" tabindex="7" required><br/>
            ...
            <div class="col-sm-6 col-xs-6 col-md-6 col-md-6">
               ...
               <input type="email" class="form-control" name="email" tabindex="6"  required><br/>
                ...
                <select class="form-control" name="option" tabindex="8"  required>
                  <option>Informatique</option>
                  <option>Mathématiques</option>
                  <option>Méthodes quantitatives</option>
                </select>
            </div>
